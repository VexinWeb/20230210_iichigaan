    ...
    <div className={categoriesStyle.categories}>
      ...
      <div className={categoriesStyle.column}>
        <div className={categoriesStyle.row}>
          ...
          />
          <button>
            <Link className={categoriesStyle.link} href="/products/3">
              Nouveautés
            </Link>
          </button>
        </div>
      ...
      <div className={(categoriesStyle.columnLarge, categoriesStyle.column)}>
        <div className={categoriesStyle.row}>
          <div className={categoriesStyle.column}>
            <div className={categoriesStyle.row}>
              ...
              />
              <button>
                <Link className={categoriesStyle.link} href="/products/4">
                  Vêtements2
                </Link>
              </button>
            </div>
        ...
        <div className={categoriesStyle.row}>
          ...
          />
          <button>
            <Link className={categoriesStyle.link} href="/products/6">
              Nouveautés2
            </Link>
          </button>
        </div>
