...
export default function Home({ featuredProducts, trendingProducts }) {
  ...
  const featuredText = t("featuredProductsText");
  const trendingText = t("trendingProductsText");
  return (
  ...
  const responseFeaturedProducts = {
        "data": [
        {
            ...
            "attributes": {
                ...
                "type": "featured",
                "locale": "fr",
                "description": "Ce porte clés a été réalisé en véritable cuir de chèvre dans la pure tradition artisanale touareg.\n\nVéritable cuir de chèvre teint à la main."
            }
        },
        {
            "id": 7,
            "attributes": {
                ...
                "type": "featured",
                "locale": "fr",
                "description": "Ce kimono court a été réalisé en tissu wax.\n\nCeinture en wax fournie avec le kimono."
            }
        },
    ],
        "meta": {
